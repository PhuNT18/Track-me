package com.phunt.trackme.service
...
import com.phunt.trackme.utils.LocationService.Companion.EXTRA_STARTED_FROM_NOTIFICATION
...
//    private val PACKAGE_NAME = "com.phunt.trackme.service.LocationUpdatesService"
...
//    private val EXTRA_STARTED_FROM_NOTIFICATION: String = PACKAGE_NAME + ".started_from_notification"
    ...
    fun requestLocationUpdates() {
        ...
        try {
            ...
            Utils.setRequestingLocationUpdates(MainApplication.instance, false)
    ...
    fun removeLocationUpdates() {
        ...
        try {
            ...
            Utils.setRequestingLocationUpdates(MainApplication.instance, true)
    ...
    private fun onNewLocation(location: Location) {
        ...
        mLocation = location
        mDataManager.points?.add(LatLng(location.latitude, location.longitude))
